        ...
        Scheduler.get().scheduleDeferred(new Scheduler.ScheduledCommand() {
            ...
            public void execute() {
                ...
                if (lastWidget.getDirection() == 0) {
                    helpCallout.getElement().getStyle().setLeft(widgetRight - Constants.HELP_CALLOUT_OVERLAP, Style.Unit.PX);
                    helpCallout.getElement().getStyle().setTop(widgetBottom - Constants.HELP_CALLOUT_OVERLAP, Style.Unit.PX);
                    ...
                    helpCallout.getElement().getStyle().setLeft(widgetRight - widgetWidth - calloutWidth + Constants.HELP_CALLOUT_OVERLAP, Style.Unit.PX);
                    helpCallout.getElement().getStyle().setTop(widgetTop + widgetHeight - Constants.HELP_CALLOUT_OVERLAP, Style.Unit.PX);
                } else if (lastWidget.getDirection() == 3) {
                    helpCallout.getElement().getStyle().setLeft(widgetLeft - calloutWidth + Constants.HELP_CALLOUT_OVERLAP, Style.Unit.PX);
                    ...
                    helpCallout.getElement().getStyle().setLeft(widgetRight - widgetWidth - calloutWidth + Constants.HELP_CALLOUT_OVERLAP, Style.Unit.PX);
                    helpCallout.getElement().getStyle().setTop(widgetTop - calloutHeight + Constants.HELP_CALLOUT_OVERLAP, Style.Unit.PX);
