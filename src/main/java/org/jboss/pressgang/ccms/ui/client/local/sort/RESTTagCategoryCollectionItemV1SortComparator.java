 ...
 */
public class RESTTagCategoryCollectionItemV1SortComparator implements Comparator<RESTTagCategoryCollectionItemV1> {

    @Override
    public int compare(final RESTTagCategoryCollectionItemV1 arg0, final RESTTagCategoryCollectionItemV1 arg1) {
