        ...
        @NotNull final EnhancedAsyncDataProvider<RESTBlobConstantCollectionItemV1> provider = new
            ...
            protected void onRangeChanged(@NotNull final HasData<RESTBlobConstantCollectionItemV1> list) {
                try {
                    ...
                    @NotNull final BaseRestCallback<RESTBlobConstantCollectionV1,
                            Display> callback = new BaseRestCallback<RESTBlobConstantCollectionV1, Display>(
                            display, new BaseRestCallback.SuccessAction<RESTBlobConstantCollectionV1, Display>() {
                        @Override
