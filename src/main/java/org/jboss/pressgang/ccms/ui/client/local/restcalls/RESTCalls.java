...
public final class RESTCalls {
    ...
    public static void saveTopic(@NotNull final RESTCallback<RESTTopicV1> callback, @NotNull final RESTTopicV1 topic,
            @NotNull final String message, @NotNull final Integer flag, @NotNull final String userId) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void getTopicWithRevisions(@NotNull final RESTCallback<RESTTopicV1> callback, @NotNull final Integer id, final int start,
            final int end) {
    ...
    public static void getTopicRevisionWithBugs(@NotNull final RESTCallback<RESTTopicV1> callback, @NotNull final Integer id,
    ...
    public static void getTopicRevisionWithProperties(@NotNull final RESTCallback<RESTTopicV1> callback, @NotNull final Integer id,
            @NotNull final Integer revision) {
        /* Expand the categories and projects in the tags */
    ...
    public static void getTopicRevisionWithTags(@NotNull final RESTCallback<RESTTopicV1> callback, @NotNull final Integer id,
            @NotNull final Integer revision) {
        /* Expand the categories and projects in the tags */
        final String expand = "{\"branches\":[" + TOPIC_AND_CONTENT_SPEC_TAGS_EXPANSION + "]}";
        doRestCall(callback, new RestMethodCaller() {
    ...
    public static void getFiltersFromQuery(@NotNull final RESTCallback<RESTFilterCollectionV1> callback, @NotNull final String queryString,
    ...
    public static void getTopicRevision(@NotNull final RESTCallback<RESTTopicV1> callback, @NotNull final Integer id,
            @NotNull final Integer revision) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void getTopicsFromQueryWithExpandedTags(@NotNull final RESTCallback<RESTTopicCollectionV1> callback,
    ...
    public static void getTranslatedTopicsFromQuery(@NotNull final RESTCallback<RESTTranslatedTopicCollectionV1> callback,
    ...
    public static void getStringConstantsFromQuery(@NotNull final RESTCallback<RESTStringConstantCollectionV1> callback,
            @NotNull final String queryString, final int start, final int end) {
        final String expand = "{\"branches\":[{\"trunk\":{\"start\": " + start + ", \"end\": " + end + ", " +
    ...
    public static void createStringConstant(@NotNull final RESTCallback<RESTStringConstantV1> callback,
            @NotNull final RESTStringConstantV1 entity) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void updateStringConstant(@NotNull final RESTCallback<RESTStringConstantV1> callback,
            @NotNull final RESTStringConstantV1 entity) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void getIntegerConstantsFromQuery(@NotNull final RESTCallback<RESTIntegerConstantCollectionV1> callback,
            @NotNull final String queryString, final int start, final int end) {
        final String expand = "{\"branches\":[{\"trunk\":{\"start\": " + start + ", \"end\": " + end + ", " +
    ...
    public static void createIntegerConstant(@NotNull final RESTCallback<RESTIntegerConstantV1> callback,
            @NotNull final RESTIntegerConstantV1 entity) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void updateIntegerConstant(@NotNull final RESTCallback<RESTIntegerConstantV1> callback,
            @NotNull final RESTIntegerConstantV1 entity) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void getBlobConstantsFromQuery(@NotNull final RESTCallback<RESTBlobConstantCollectionV1> callback,
            @NotNull final String queryString, final int start, final int end) {
        final String expand = "{\"branches\":[{\"trunk\":{\"start\": " + start + ", \"end\": " + end + ", " +
    ...
    public static void createBlobConstant(@NotNull final RESTCallback<RESTBlobConstantV1> callback,
            @NotNull final RESTBlobConstantV1 entity) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void updateBlobConstant(@NotNull final RESTCallback<RESTBlobConstantV1> callback,
            @NotNull final RESTBlobConstantV1 entity) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void getContentSpecTextRevision(@NotNull final RESTCallback<String> callback, @NotNull final Integer id,
            @NotNull final Integer revision) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void updateContentSpecText(@NotNull final RESTCallback<String> callback, @NotNull final Integer contentSpecID,
            @NotNull final String contentSpecText, @NotNull final Boolean permissive, @NotNull final String message,
            @NotNull final Integer flag, @NotNull final String userId) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
                createRestMethod(callback).updateTEXTContentSpec(contentSpecID, contentSpecText, permissive, message, flag, userId);
            }
        });
    }
    ...
    public static void getContentSpec(@NotNull final RESTCallback<RESTTextContentSpecV1> callback, @NotNull final Integer id) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
                createRestMethod(callback).getJSONTextContentSpec(id, "{\"branches\":[" + CONTENT_SPEC_ITEM_EXPANSION + "]}");
            }
        });
    }

    public static void getContentSpecRevision(@NotNull final RESTCallback<RESTTextContentSpecV1> callback, @NotNull final Integer id,
            @NotNull final Integer revision) {
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
                createRestMethod(callback).getJSONTextContentSpecRevision(id, revision, CONTENT_SPEC_EXPANSION_WO_REVISIONS);
            }
        });
    }

    public static void getContentSpecWithRevisions(@NotNull final RESTCallback<RESTTextContentSpecV1> callback, @NotNull final Integer id,
            final int start, final int end) {
        final String revisionExpand = "{\"branches\":[" +
                "{\"trunk\":{\"name\": \"" + RESTTopicV1.REVISIONS_NAME + "\", \"start\":" + start + ", \"end\":" + end + "}," +
                "\"branches\":[" +
        ...
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
                createRestMethod(callback).getJSONTextContentSpec(id, revisionExpand);
            }
        });
    }

    public static void getContentSpecWithTags(@NotNull final RESTCallback<RESTTextContentSpecV1> callback, @NotNull final Integer id) {
        final String expand = "{\"branches\":[" + TOPIC_AND_CONTENT_SPEC_TAGS_EXPANSION + "]}";
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
                createRestMethod(callback).getJSONTextContentSpec(id, expand);
            }
        });
    }

    public static void getContentSpecsFromQuery(@NotNull final RESTCallback<RESTTextContentSpecCollectionV1> callback,
            @NotNull final String queryString, final int start, final int end) {
        final String expand = "{\"branches\":[{\"trunk\":{\"start\": " + start + ", \"end\": " + end + ", " +
        ...
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
                createRestMethod(callback).getJSONTextContentSpecsWithQuery(new PathSegmentImpl(queryString), expand);
            }
        });
    }
    ...
    public static void getCategoriesFromQuery(@NotNull final RESTCallback<RESTCategoryCollectionV1> callback,
            @NotNull final String queryString, final int start, final int end) {
        /* Expand the categories and projects in the tags */
        final String expand = "{\"branches\":[{\"trunk\":{\"start\": " + start + ", \"end\": " + end + ", " +
    ...
    public static void getProjectsFromQuery(@NotNull final RESTCallback<RESTProjectCollectionV1> callback,
            @NotNull final String queryString, final int start, final int end) {
        /* Expand the categories and projects in the tags */
        final String expand = "{\"branches\":[{\"trunk\":{\"start\": " + start + ", \"end\": " + end + ", " +
     ...
     */
    public static void getPropertyTagsFromQuery(@NotNull final RESTCallback<RESTPropertyTagCollectionV1> callback,
            @NotNull final String queryString, final int start, final int end) {
        final String expand = "{\"branches\":[{\"trunk\":{\"start\":" + start + ", \"end\":" + end + "," +
    ...
    public static void savePropertyTag(@NotNull final RESTCallback<RESTPropertyTagV1> callback,
            @NotNull final RESTPropertyTagV1 propertyTag) {
        final String expand = "{\"branches\":[" + PROPERTY_TAG_EXPANSION + "]}";
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void createPropertyTag(@NotNull final RESTCallback<RESTPropertyTagV1> callback,
            @NotNull final RESTPropertyTagV1 propertyTag) {
        final String expand = "{\"branches\":[" + PROPERTY_TAG_EXPANSION + "]}";
        doRestCall(callback, new RestMethodCaller() {
            @Override
     ...
     * @param end         The end of the range of returned entities
     */
    public static void getPropertyCategoriesFromQuery(@NotNull final RESTCallback<RESTPropertyCategoryCollectionV1> callback,
            @NotNull final String queryString, final int start, final int end) {
        final String expand = "{\"branches\":[{\"trunk\":{\"start\":" + start + ", \"end\":" + end + "," +
    ...
    public static void savePropertyCategory(@NotNull final RESTCallback<RESTPropertyCategoryV1> callback,
            @NotNull final RESTPropertyCategoryV1 propertyCategory) {
        final String expand = "{\"branches\":[" + PROPERTY_CATEGORY_EXPANSION + "]}";
        doRestCall(callback, new RestMethodCaller() {
            @Override
            public void call() throws Exception {
    ...
    public static void createPropertyCategory(@NotNull final RESTCallback<RESTPropertyCategoryV1> callback,
            @NotNull final RESTPropertyCategoryV1 propertyCategory) {
        final String expand = "{\"branches\":[" + PROPERTY_CATEGORY_EXPANSION + "]}";
        doRestCall(callback, new RestMethodCaller() {
            @Override
    ...
    public static void populateLocales(@NotNull final StringListLoaded loadedCallback, @NotNull final BaseTemplateViewInterface display) {
        ...
        @NotNull final RESTCalls.RESTCallback<RESTStringConstantV1> callback = new BaseRestCallback<RESTStringConstantV1,
            ...
            public void doSuccessAction(@NotNull final RESTStringConstantV1 retValue, final BaseTemplateViewInterface display) {
                ...
                @NotNull final List<String> locales = new LinkedList<String>(Arrays.asList(
                        retValue.getValue().replaceAll(Constants.CARRIAGE_RETURN_AND_LINE_BREAK_ESCAPED, "").replaceAll(
                                Constants.LINE_BREAK_ESCAPED, "").replaceAll(" ", "").split(Constants.COMMA)));
