...
public final class DocbookToHTML {
    ...
    public static final String XSL = "<xsl:stylesheet xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\" version=\"1.0\">\n"
            ...
            + "    <xsl:param name=\"externalImagesUrlPrefix\" select=\"'http://skynet.usersys.redhat.com:8080/pressgang-ccms/rest/1/image/get/raw/'\"/>\n"
            + "    \n"
            + "    <!-- The end of the url that is used to get the images from the server -->\n"
            + "    <xsl:param name=\"externalImagesUrlSuffix\" select=\"''\"/>\n"
            + "    <xsl:template name=\"lineNumberAttibute\">\n"
            + "        <xsl:param name=\"value\" select=\".\"/>\n"
            + "            <xsl:if test=\"$value[@pressgangeditorlinenumber]\">\n"
            + "                <xsl:attribute name=\"pressgangeditorlinenumber\">\n"
            + "                    <xsl:value-of select=\"$value/@pressgangeditorlinenumber\" />\n"
            + "                </xsl:attribute>\n"
            + "            </xsl:if>\n"
            + "    </xsl:template>\n"
            + "    \n"
            ...
            + "    </xsl:template>\n"
            + "    <!--"
            + "    <xsl:template match=\"article\"> <div id=\"{@id}\" class=\"docbookArticle\"> "
            + "        <h1 class=\"title\"> "
            ...
            + "            <xsl:call-template name=\"lineNumberAttibute\"/>\n"
            + "            <xsl:choose>\n"
            + "                <xsl:when test=\"$secdepth = 1\">\n"
            + "                    <h2 class=\"docbookSectionTitle\">\n"
            + "                        <xsl:call-template name=\"lineNumberAttibute\"><xsl:with-param name=\"value\" select=\"title\"/></xsl:call-template>\n"
            + "                        <xsl:value-of select=\"title\" />\n"
            + "                    </h2>\n"
            + "                </xsl:when>\n"
            ...
            + "        <div id=\"{@id}\" class=\"docbookVarlistentry\">\n"
            + "            <xsl:call-template name=\"lineNumberAttibute\"/>\n"
