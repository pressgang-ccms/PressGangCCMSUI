 ...
 */
public final class RESTContentSpecCollectionItemIDSort implements Comparator<RESTContentSpecCollectionItemV1> {
    private final boolean ascending;

    /**
     * @param ascending true if the items should be sorted in ascending order, false otherwise
     */
    public RESTContentSpecCollectionItemIDSort(final boolean ascending) {
