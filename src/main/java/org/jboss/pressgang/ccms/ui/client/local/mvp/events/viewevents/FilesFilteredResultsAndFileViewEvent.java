...
/**
 * Event used to display the Images view.
 */
public final class FilesFilteredResultsAndFileViewEvent extends ViewOpenWithQueryEvent<ViewOpenWithQueryEventHandler> {
     ...
     */
    public FilesFilteredResultsAndFileViewEvent(@NotNull final String query, final boolean newWindow) {
