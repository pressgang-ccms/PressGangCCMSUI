...
public class StringConstantFilteredResultsPresenter extends BaseFilteredResultsPresenter<RESTStringConstantCollectionItemV1> {
    ...
    @NotNull
    @Override
    protected EnhancedAsyncDataProvider<RESTStringConstantCollectionItemV1> generateListProvider(@NotNull final String queryString,
        ...
        return new EnhancedAsyncDataProvider<RESTStringConstantCollectionItemV1>() {
            ...
            protected void onRangeChanged(@NotNull final HasData<RESTStringConstantCollectionItemV1> list) {
                ...
                @NotNull final BaseRestCallback<RESTStringConstantCollectionV1,
                        Display> callback = new BaseRestCallback<RESTStringConstantCollectionV1, Display>(
                        display, new BaseRestCallback.SuccessAction<RESTStringConstantCollectionV1, Display>() {
                    @Override
