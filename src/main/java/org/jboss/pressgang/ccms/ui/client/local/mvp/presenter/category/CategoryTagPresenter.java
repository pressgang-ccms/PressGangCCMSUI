                            ...
                            Collections.sort(retValue.getItems(), new Comparator<RESTTagCollectionItemV1>() {
                                ...
                                public int compare(@Nullable final RESTTagCollectionItemV1 arg0, @Nullable final RESTTagCollectionItemV1 arg1) {
                                    ...
                                    if (arg1 == null) {
                                         ...
                                         */
                                    final RESTCategoryV1 displayItem = getParent();
                                    if (displayItem != null && displayItem.getTags() != null && displayItem.getTags().getItems() != null) {

                                        final boolean arg0IsChild = ComponentCategoryV1.containsTag(displayItem, arg0.getItem().getId());
                                        final boolean arg1IsChild = ComponentCategoryV1.containsTag(displayItem, arg1.getItem().getId());
