...
public class RenderedDiffEvent extends ViewOpenWithQueryEvent<ViewOpenWithQueryEventHandler> {
     ...
     */
    public RenderedDiffEvent(@NotNull final String query, final boolean newWindow) {
