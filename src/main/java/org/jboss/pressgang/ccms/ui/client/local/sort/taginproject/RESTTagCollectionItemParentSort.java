package org.jboss.pressgang.ccms.ui.client.local.sort.taginproject;
...
public class RESTTagCollectionItemParentSort implements Comparator<RESTTagCollectionItemV1> {
    @NotNull final RESTProjectV1 parent;
     ...
     */
    public RESTTagCollectionItemParentSort(@NotNull final RESTProjectV1 parent, final boolean ascending) {
        this.parent = parent;
    ...
    public int compare(@Nullable final RESTTagCollectionItemV1 arg0, @Nullable final RESTTagCollectionItemV1 arg1) {
        ...
        */
         ...
         */
        final boolean arg0IsChild = ComponentProjectV1.containsTag(parent, arg0.getItem().getId());
        final boolean arg1IsChild = ComponentProjectV1.containsTag(parent, arg1.getItem().getId());
