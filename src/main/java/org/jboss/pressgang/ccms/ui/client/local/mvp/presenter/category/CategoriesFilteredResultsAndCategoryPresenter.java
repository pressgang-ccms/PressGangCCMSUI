...
public class CategoriesFilteredResultsAndCategoryPresenter
    ...
    public void go(@NotNull final HasWidgets container) {
        ...
        categoryTagPresenter.bindExtended(ServiceConstants.DEFAULT_HELP_TOPIC, HISTORY_TOKEN);
    ...
    protected void initializeViews(@Nullable final List<BaseTemplateViewInterface> filter) {
        try {
            ...
            if (viewIsInFilter(filter, categoryTagPresenter.getDisplay()))  {
                categoryTagPresenter.getDisplay().displayChildrenExtended(filteredResultsPresenter.getProviderData().getDisplayedItem().getItem(), false);
