...
public class BootstrapperImpl implements Bootstrapper {
  ...
  private final Default javax_enterprise_inject_Default_2803393 = new Default() {
    public Class annotationType() {
      return Default.class;
    }
  };
  private final Any javax_enterprise_inject_Any_6212573 = new Any() {
    public Class annotationType() {
      return Any.class;
    }
  };
  private final Annotation[] arrayOf_java_lang_annotation_Annotation_27087422 = new Annotation[] { javax_enterprise_inject_Default_2803393, javax_enterprise_inject_Any_6212573 };
  ...
  private final CreationalCallback<RequestDispatcherProvider> inj1897_RequestDispatcherProvider_creationalCallback = new CreationalCallback<RequestDispatcherProvider>() {
    public RequestDispatcherProvider getInstance(final CreationalContext context) {
      ...
      Annotation[] qualifiers = arrayOf_java_lang_annotation_Annotation_27087422;
  ...
  private final CreationalCallback<App> inj1900_App_creationalCallback = new CreationalCallback<App>() {
    public App getInstance(final CreationalContext context) {
      ...
      }, AppController.class, arrayOf_java_lang_annotation_Annotation_27087422);
  ...
  private final CreationalCallback<HandlerManager> inj1876_HandlerManager_creationalCallback = new CreationalCallback<HandlerManager>() {
    public HandlerManager getInstance(CreationalContext pContext) {
      ...
      context.addBean(context.getBeanReference(HandlerManager.class, arrayOf_java_lang_annotation_Annotation_27087422), var1);
      return var1;
    }
  };
  ...
  private void declareBeans_0() {
    injContext.addBean(RequestDispatcherProvider.class, RequestDispatcherProvider.class, inj1897_RequestDispatcherProvider_creationalCallback, inj1882_RequestDispatcherProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(Provider.class, RequestDispatcherProvider.class, inj1897_RequestDispatcherProvider_creationalCallback, inj1882_RequestDispatcherProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(InstanceProvider.class, InstanceProvider.class, inj1898_InstanceProvider_creationalCallback, inj1896_InstanceProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(ContextualTypeProvider.class, InstanceProvider.class, inj1898_InstanceProvider_creationalCallback, inj1896_InstanceProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(IOCBeanManagerProvider.class, IOCBeanManagerProvider.class, inj1899_IOCBeanManagerProvider_creationalCallback, inj1890_IOCBeanManagerProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(Provider.class, IOCBeanManagerProvider.class, inj1899_IOCBeanManagerProvider_creationalCallback, inj1890_IOCBeanManagerProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(App.class, App.class, inj1900_App_creationalCallback, inj609_App, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(HandlerManager.class, HandlerManager.class, inj1876_HandlerManager_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(HasHandlers.class, HandlerManager.class, inj1876_HandlerManager_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(AppController.class, AppController.class, inj1903_AppController_creationalCallback, inj1902_AppController, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(Presenter.class, AppController.class, inj1903_AppController_creationalCallback, inj1902_AppController, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(ValueChangeHandler.class, AppController.class, inj1903_AppController_creationalCallback, inj1902_AppController, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(EventHandler.class, AppController.class, inj1903_AppController_creationalCallback, inj1902_AppController, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(EventProvider.class, EventProvider.class, inj1904_EventProvider_creationalCallback, inj1892_EventProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(ContextualTypeProvider.class, EventProvider.class, inj1904_EventProvider_creationalCallback, inj1892_EventProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(MessageBusProvider.class, MessageBusProvider.class, inj1905_MessageBusProvider_creationalCallback, inj1888_MessageBusProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(Provider.class, MessageBusProvider.class, inj1905_MessageBusProvider_creationalCallback, inj1888_MessageBusProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(SenderProvider.class, SenderProvider.class, inj1906_SenderProvider_creationalCallback, inj1894_SenderProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(ContextualTypeProvider.class, SenderProvider.class, inj1906_SenderProvider_creationalCallback, inj1894_SenderProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(WelcomeView.class, WelcomeView.class, inj1909_WelcomeView_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(Display.class, WelcomeView.class, inj1909_WelcomeView_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(BaseTemplateViewInterface.class, WelcomeView.class, inj1909_WelcomeView_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(BaseTemplateView.class, WelcomeView.class, inj1909_WelcomeView_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(WelcomePresenter.class, WelcomePresenter.class, inj1908_WelcomePresenter_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(TemplatePresenter.class, WelcomePresenter.class, inj1908_WelcomePresenter_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(Presenter.class, WelcomePresenter.class, inj1908_WelcomePresenter_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(InitBallotProvider.class, InitBallotProvider.class, inj1910_InitBallotProvider_creationalCallback, inj1886_InitBallotProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(ContextualTypeProvider.class, InitBallotProvider.class, inj1910_InitBallotProvider_creationalCallback, inj1886_InitBallotProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(CallerProvider.class, CallerProvider.class, inj1911_CallerProvider_creationalCallback, inj1878_CallerProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(ContextualTypeProvider.class, CallerProvider.class, inj1911_CallerProvider_creationalCallback, inj1878_CallerProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(RootPanelProvider.class, RootPanelProvider.class, inj1912_RootPanelProvider_creationalCallback, inj1884_RootPanelProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(Provider.class, RootPanelProvider.class, inj1912_RootPanelProvider_creationalCallback, inj1884_RootPanelProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(SearchView.class, SearchView.class, inj1915_SearchView_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(org.jboss.pressgangccms.client.local.presenter.SearchPresenter.Display.class, SearchView.class, inj1915_SearchView_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(BaseTemplateViewInterface.class, SearchView.class, inj1915_SearchView_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(BaseTemplateView.class, SearchView.class, inj1915_SearchView_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(SearchPresenter.class, SearchPresenter.class, inj1914_SearchPresenter_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(TemplatePresenter.class, SearchPresenter.class, inj1914_SearchPresenter_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(Presenter.class, SearchPresenter.class, inj1914_SearchPresenter_creationalCallback, null, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
    injContext.addBean(DisposerProvider.class, DisposerProvider.class, inj1916_DisposerProvider_creationalCallback, inj1880_DisposerProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, true);
    injContext.addBean(ContextualTypeProvider.class, DisposerProvider.class, inj1916_DisposerProvider_creationalCallback, inj1880_DisposerProvider, arrayOf_java_lang_annotation_Annotation_27087422, null, false);
  }
