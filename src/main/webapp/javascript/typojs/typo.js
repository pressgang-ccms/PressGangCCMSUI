...
Typo.prototype = {
	...
	suggest : function (word, limit, callback) {
		...
		*/
		...
		/**
		 * This function has been completely rewritten to utilize web workers. This speeds up the generation of
		 * suggested words for longer words significantly.
		 * @param words	The words to generate possible editos from
		 * @param callback The callback called when the words have been found
		 */
