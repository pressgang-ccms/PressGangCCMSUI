(function () {
	...
	(function () {
		this.tokenRe = new RegExp("^[" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]|s])+", "g"), this.getTokenizer = function () {
			...
			var i = t.doc, s = !0, o = !0, a = Infinity;
			if (!this.lineCommentStart) {
				if (!this.blockComment)return!1;
				var f = this.blockComment.start, l = this.blockComment.end, c = new RegExp("^(\\s*)(?:" + u.escapeRegExp(f) + ")"), h = new RegExp("(?:" + u.escapeRegExp(l) + ")\\s*$"), p = function (e, t) {
					if (v(e, t))return;
					if (!s || /\S/.test(e))i.insertInLine({row: t, column: e.length}, l), i.insertInLine({row: t, column: a}, f)
				}, d = function (e, t) {
					var n;
				...
				if (Array.isArray(this.lineCommentStart))var c = this.lineCommentStart.map(u.escapeRegExp).join("|"), f = this.lineCommentStart[0] + " "; else var c = u.escapeRegExp(this.lineCommentStart), f = this.lineCommentStart + " ";
				c = new RegExp("^(\\s*)(?:" + c + ") ?");
				var d = function (e, t) {
					var n = e.match(c);
					n && i.removeInLine(t, n[1].length, n[0].length)
				}, p = function (e, t) {
					(!s || /\S/.test(e)) && i.insertInLine({row: t, column: a}, f)
				}, v = function (e, t) {
					return c.test(e)
				}
			}
