define("ace/ext/options", ["require", "exports", "module"], function (e, t, n) {
	...
	var r = modelist.modesByName, i = [
		...
		["Split", function (e) {
			var t = env.split;
			if (e == "none")t.getSplits() == 2 && (env.secondSession = t.getEditor(1).session), t.setSplits(1); else {
				var n = t.getSplits() == 1;
				e == "below" ? t.setOrientation(t.BELOW) : t.setOrientation(t.BESIDE), t.setSplits(2);
				if (n) {
					var r = env.secondSession || t.getEditor(0).session, i = t.setSession(r, 1);
					i.name = r.name
				}
			}
		}, ["None", "Beside", "Below"]],
		...
		return r.style.cssText = "width: 120%;height:100%;overflow: scroll", n.appendChild(r), t.push("<table><tbody>"), e.forEach(function (e) {
		}), t.push("<tr>", "<td>", '<label for="', s, '"></label>', "</td><td>", '<input type="', s, '" name="', s, '" id="', s, '">', "</td>", "</tr>"), t.push("</tbody></table>"), n
	};
	o(i)
})