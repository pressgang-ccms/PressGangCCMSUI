define("ace/mode/lsl", ["require", "exports", "module", "ace/tokenizer", "ace/mode/lsl_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/text", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/lib/oop"], function (e, t, n) {
	var r = e("../tokenizer").Tokenizer, i = e("./lsl_highlight_rules").LSLHighlightRules, s = e("./matching_brace_outdent").MatchingBraceOutdent, o = e("../range").Range, u = e("./text").Mode, a = e("./behaviour/cstyle").CstyleBehaviour, f = e("./folding/cstyle").FoldMode, l = e("../lib/oop"), c = function () {
		this.$tokenizer = new r((new i).getRules()), this.$outdent = new s, this.$behaviour = new a, this.foldingRules = new f
	};
