define("ace/mode/html_ruby", ["require", "exports", "module", "ace/lib/oop", "ace/tokenizer", "ace/mode/html_ruby_highlight_rules", "ace/mode/html", "ace/mode/javascript", "ace/mode/css", "ace/mode/ruby"], function (e, t, n) {
	var r = e("../lib/oop"), i = e("../tokenizer").Tokenizer, s = e("./html_ruby_highlight_rules").HtmlRubyHighlightRules, o = e("./html").Mode, u = e("./javascript").Mode, a = e("./css").Mode, f = e("./ruby").Mode, l = function () {
		o.call(this);
		var e = new s;
		this.$tokenizer = new i(e.getRules()), this.$embeds = e.getEmbeds(), this.createModeDelegates({"js-": u, "css-": a, "ruby-": f})
	};
	...
	var r = e("../lib/oop"), i = e("./html_highlight_rules").HtmlHighlightRules, s = e("./ruby_highlight_rules").RubyHighlightRules, o = function () {
		i.call(this);
		for (var e in this.$rules)this.$rules[e].unshift({regex: "<%%|%%>", token: "constant.language.escape"}, {token: "comment.start.erb", regex: "<%#", push: [
			{regex: "%>", next: "pop"}
		]}, {token: "support.ruby_tag", regex: "<%+(?!>)[-=]?", push: "ruby-start"});
		this.embedRules(s, "ruby-"), this.$rules["ruby-start"].unshift({token: "support.ruby_tag", regex: "%>", next: "pop"}, {token: "comment", regex: /#(?:[^%]|%[^>])*/}), this.normalizeRules()
	};
	...
	var r = e("../lib/oop"), i = e("../lib/lang"), s = e("./css_highlight_rules").CssHighlightRules, o = e("./javascript_highlight_rules").JavaScriptHighlightRules, u = e("./xml_util"), a = e("./text_highlight_rules").TextHighlightRules, f = i.createMap({a: "anchor", button: "form", form: "form", img: "image", input: "form", label: "form", script: "script", select: "form", textarea: "form", style: "style", table: "table", tbody: "table", td: "table", tfoot: "table", th: "table", tr: "table"}), l = function () {
		this.$rules = {start: [
			...
			{token: "meta.tag", regex: "<\\/?(?=\\S)", next: "tag"},
			{token: "text", regex: "\\s+"},
	...
	r.inherits(l, i), function () {
		this.lineCommentStart = "#", this.getNextLineIndent = function (e, t, n) {
			...
			if (s.length && s[s.length - 1].type == "comment")return r;
			if (e == "start") {
				var o = t.match(/^.*[\{\(\[]\s*$/), u = t.match(/^\s*(class|def)\s.*$/), a = t.match(/.*do(\s*|\s+\|.*\|\s*)$/), f = t.match(/^\s*(if|else)\s*/);
				if (o || u || a || f)r += n
			}
			return r
		}, this.checkOutdent = function (e, t, n) {
