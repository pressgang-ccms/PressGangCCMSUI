define("ace/ext/static_highlight", ["require", "exports", "module", "ace/edit_session", "ace/layer/text", "ace/config"], function (e, t, n) {
	...
	t.render = function (e, n, r, i, s, u) {
		...
		var a = 0;
		return typeof r == "string" && (a++, o.loadModule(["theme", r], function (e) {
			r = e, --a || f()
		})), typeof n == "string" && (a++, o.loadModule(["mode", n], function (e) {
			n = new e.Mode, --a || f()
		})), a || f()
