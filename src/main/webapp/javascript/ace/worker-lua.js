...
}), define("ace/mode/lua/luaparse", ["require", "exports", "module", "exports"], function (e, t, n) {
	(function (e, n, r) {
		typeof t != "undefined" ? r(t) : typeof define == "function" && define.amd ? define(["exports"], r) : r(e[n] = {})
		...
		function r(e) {
			var n = t.apply(null, kt.call(arguments, 1)), r, i;
			throw"undefined" != typeof e.line ? (i = e.range[0] - e.lineStart, r = new SyntaxError(t("[%1:%2] %3", e.line, i, n)), r.line = e.line, r.index = e.range[0], r.column = i) : (i = Ot - Bt + 1, r = new SyntaxError(t("[%1:%2] %3", Ht, i, n)), r.index = Ot, r.line = Ht, r.column = i), r
		}
		...
		function o() {
			u();
			while (45 === ht.charCodeAt(Ot) && 45 === ht.charCodeAt(Ot + 1))g(), u();
			if (Ot >= dt)return{type: mt, value: "<eof>", line: Ht, lineStart: Bt, range: [Ot, Ot]};
			var e = ht.charCodeAt(Ot), t = ht.charCodeAt(Ot + 1);
			Pt = Ot;
			if (C(e))return a();
			switch (e) {
				case 39:
		...
		function a() {
			...
			return e = ht.slice(Pt, Ot), L(e) ? t = yt : "true" === e || "false" === e ? (t = St, e = "true" === e) : "nil" === e ? (t = xt, e = null) : t = bt, {type: t, value: e, line: Ht, lineStart: Bt, range: [Pt, Ot]}
		}

		function f(e) {
			return Ot += e.length, {type: Et, value: e, line: Ht, lineStart: Bt, range: [Pt, Ot]}
		}

		function l() {
			return Ot += 3, {type: Tt, value: "...", line: Ht, lineStart: Bt, range: [Pt, Ot]}
		}

		function c() {
			var e = ht.charCodeAt(Ot++), t = Ot, n = "", i;
			while (Ot < dt) {
				i = ht.charCodeAt(Ot++);
				if (e === i)break;
				if (92 === i)n += ht.slice(t, Ot - 1) + m(), t = Ot; else if (Ot >= dt || x(i))n += ht.slice(t, Ot - 1), r({}, Nt.unfinishedString, n + String.fromCharCode(i))
			}
			return n += ht.slice(t, Ot - 1), {type: gt, value: n, line: Ht, lineStart: Bt, range: [Pt, Ot]}
		}

		function h() {
			var e = y();
			return!1 === e && r(Mt, Nt.expected, "[", Mt.value), {type: gt, value: e, line: Ht, lineStart: Bt, range: [Pt, Ot]}
		}

		function p() {
			var e = ht.charAt(Ot), t = ht.charAt(Ot + 1), n = "0" === e && "xX".indexOf(t || null) >= 0 ? d() : v();
			return{type: wt, value: n, line: Ht, lineStart: Bt, range: [Pt, Ot]}
		}

		function d() {
			var e = 0, t = 1, n = 1, i, s, o, u;
			u = Ot += 2, N(ht.charCodeAt(Ot)) || r({}, Nt.malformedNumber, ht.slice(Pt, Ot));
			while (N(ht.charCodeAt(Ot)))Ot++;
			i = parseInt(ht.slice(u, Ot), 16);
			if ("." === ht.charAt(Ot)) {
				s = ++Ot;
				while (N(ht.charCodeAt(Ot)))Ot++;
				e = ht.slice(s, Ot), e = s === Ot ? 0 : parseInt(e, 16) / Math.pow(16, Ot - s)
			}
			if ("pP".indexOf(ht.charAt(Ot) || null) >= 0) {
				Ot++, "+-".indexOf(ht.charAt(Ot) || null) >= 0 && (n = "+" === ht.charAt(Ot++) ? 1 : -1), o = Ot, T(ht.charCodeAt(Ot)) || r({}, Nt.malformedNumber, ht.slice(Pt, Ot));
		...
		function v() {
			...
			if ("eE".indexOf(ht.charAt(Ot) || null) >= 0) {
				Ot++, "+-".indexOf(ht.charAt(Ot) || null) >= 0 && Ot++, T(ht.charCodeAt(Ot)) || r({}, Nt.malformedNumber, ht.slice(Pt, Ot));
				while (T(ht.charCodeAt(Ot)))Ot++
			}
		...
		function m() {
			...
			switch (ht.charAt(Ot)) {
				...
				case"z":
					return Ot++, u(), "";
				case"x":
					if (N(ht.charCodeAt(Ot + 1)) && N(ht.charCodeAt(Ot + 2)))return Ot += 3, "\\" + ht.slice(e, Ot);
					return"\\" + ht.charAt(Ot++);
				default:
		...
		function g() {
			...
			pt.comments && Dt.push({type: "Comment", value: t, raw: ht.slice(Pt, Ot)})
		}
		...
		function A(e) {
			return Et === e.type ? "#-".indexOf(e.value) >= 0 : yt === e.type ? "not" === e.value : !1
		}
		...
		function B(e, t) {
			!t && -1 === At.call(qt, e.name) && (qt.push(e.name), It.push(e)), e.isLocal = t
		}
		...
		function R() {
			var e = Mt.value, t = Y();
			return pt.scope && (P("::" + e + "::"), B(t, !0)), E("::"), Ct.labelStatement(t)
		}
		...
		function z() {
			var e = Mt.value, t = Y();
			return pt.scope && (t.isLabel = j("::" + e + "::")), Ct.gotoStatement(t)
		}
		...
		function J() {
			...
			while (w("elseif"))t = rt(), E("then"), n = I(), e.push(Ct.elseifClause(t, n));
			return w("else") && (n = I(), e.push(Ct.elseClause(n))), E("end"), Ct.ifStatement(e)
		}
		...
		function K() {
			...
			if (w("=")) {
				var n = rt();
				E(",");
				var r = rt(), i = w(",") ? rt() : null;
				return E("do"), t = I(), E("end"), Ct.forNumericStatement(e, n, r, i, t)
			}
			var s = [e];
		...
		function G() {
			...
			if (",=".indexOf(Mt.value) >= 0) {
				var n = [t], r = [], o;
				while (w(","))o = ot(), null == o && i("<expression>", Mt), n.push(o);
				E("=");
				do o = rt(), r.push(o); while (w(","));
		...
		function et() {
			var e = Y(), t;
			pt.scope && B(e, !1);
			while (w("."))t = Y(), pt.scope && B(t, !1), e = Ct.memberExpression(e, ".", t);
			return w(":") && (t = Y(), pt.scope && B(t, !1), e = Ct.memberExpression(e, ":", t)), e
		}

		function tt() {
			var e = [], t, n;
			for (; ;) {
				if (Et === Mt.type && w("["))t = rt(), E("]"), E("="), n = rt(), e.push(Ct.tableKey(t, n)); else if (bt === Mt.type)t = rt(), w("=") ? (n = rt(), e.push(Ct.tableKeyString(t, n))) : e.push(Ct.tableValue(t)); else {
					if (null == (n = nt()))break;
		...
		function st(e) {
			...
			for (; ;) {
				...
				("^" === t || ".." === t) && s--, b();
				var o = st(s);
				null == o && i("<expression>", Mt), n = Ct.binaryExpression(t, n, o)
			}
			return n
		}
		...
		function ot() {
			var e, t, n;
			if (bt === Mt.type)t = Mt.value, e = Y(), pt.scope && B(e, n = j(t)); else {
				if (!w("("))return null;
				e = rt(), E(")"), pt.scope && (n = e.isLocal)
			}
			var r, i;
			for (; ;)if (Et === Mt.type)switch (Mt.value) {
				case"[":
					b(), r = rt(), e = Ct.indexExpression(e, r), E("]");
					break;
				case".":
					b(), i = Y(), pt.scope && B(i, n), e = Ct.memberExpression(e, ".", i);
					break;
				case":":
					b(), i = Y(), pt.scope && B(i, n), e = Ct.memberExpression(e, ":", i), e = ut(e);
					break;
				case"(":
				case"{":
					e = ut(e);
		...
		function at() {
			var e = gt | wt | St | xt | Tt, t = Mt.value, n = Mt.type;
			if (n & e) {
		...
		function ft(t, r) {
			return"undefined" == typeof r && "object" == typeof t && (r = t, t = undefined), r || (r = {}), ht = t || "", pt = n(vt, r), Ot = 0, Ht = 1, Bt = 0, dt = ht.length, jt = [
				[]
			], Ft = 0, It = [], qt = [], pt.comments && (Dt = []), pt.wait ? e : ct()
		}
		...
		function ct(e) {
			...
			var t = F();
			return pt.comments && (t.comments = Dt), pt.scope && (t.globals = It), t
		}

		e.version = "0.0.11";
		var ht, pt, dt, vt = e.defaultOptions = {wait: !1, comments: !0, scope: !1}, mt = 1, gt = 2, yt = 4, bt = 8, wt = 16, Et = 32, St = 64, xt = 128, Tt = 256, Nt = e.errors = {unexpected: "Unexpected %1 '%2' near '%3'", expected: "'%1' expected near '%2'", expectedToken: "%1 expected near '%2'", unfinishedString: "unfinished string near '%1'", malformedNumber: "malformed number near '%1'"}, Ct = e.ast = {labelStatement: function (e) {
			...
			return e = e === gt ? "StringLiteral" : e === wt ? "NumericLiteral" : e === St ? "BooleanLiteral" : e === xt ? "NilLiteral" : "VarargLiteral", {type: e, value: t, raw: n}
		...
		}}, kt = Array.prototype.slice, Lt = Object.prototype.toString, At = Array.prototype.indexOf || function (e) {
			for (var t = 0, n = this.length; t < n; t++)if (this[t] === e)return t;
			return-1
		}, Ot, Mt, _t, Dt, Pt, Ht, Bt, jt, Ft, It, qt;
